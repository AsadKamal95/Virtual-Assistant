...
__all__ = [
    'SPWT_DISPLAY', 'SGDSActiveUserDelimited',
    'DISPID_SRCAudioInInterferenceStatus', 'SPEI_RESERVED1',
    'DISPID_SVSInputSentencePosition',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpLexicon',
    'DISPID_SABufferInfo', 'SPFM_OPEN_READONLY',
    'DISPID_SpeechLexiconProns', 'DISPID_SRGetPropertyString',
    'DISPID_SVGetAudioInputs', 'DISPID_SGRSTPropertyId',
    'ISpPhoneticAlphabetSelection', 'SpeechRecognitionType',
    'SpeechGrammarTagWildcard', 'DISPID_SRCBookmark', 'SPWORDLIST',
    'DISPID_SVSRunningState', 'SP_VISEME_0', 'SPEVENTENUM', 'SVP_1',
    'SPRECOGNIZERSTATUS', 'SRARoot', 'SVP_19', 'DISPID_SAFType',
    'SPCT_DICTATION', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SpeechPhraseElements', 'DISPID_SpeechPhraseRule',
    'DISPID_SpeechPhraseRules', 'SpeechCategoryAudioIn',
    'SpMemoryStream', 'SPSHORTCUTPAIR', 'ISpeechVoice',
    'eLEXTYPE_RESERVED8', 'DISPID_SLWsCount', 'SAFT16kHz16BitStereo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SP_VISEME_5',
    'ISpeechRecoResultDispatch', 'DISPID_SRRGetXMLErrorInfo',
    'eWORDTYPE_DELETED', 'DISPID_SVSInputSentenceLength',
    'DISPID_SOTGetStorageFileName', 'DISPID_SRGDictationSetState',
    'DISPID_SVSyncronousSpeakTimeout', 'SVP_13', 'SDTAlternates',
    'SpeechTokenShellFolder', 'DISPID_SLPPartOfSpeech',
    'DISPID_SMSAMMHandle', 'SpeechWordType', 'ISpeechXMLRecoResult',
    'SBONone', 'DISPID_SRRDiscardResultInfo', 'eLEXTYPE_RESERVED6',
    'SP_VISEME_6', 'DISPID_SpeechObjectTokens',
    'SpPhoneticAlphabetConverter', 'DISPID_SPRText',
    'SGPronounciation', 'SECFIgnoreKanaType', 'DISPID_SRRSpeakAudio',
    'SPSHORTCUTPAIRLIST', 'DISPID_SDKOpenKey',
    'DISPID_SRCESoundStart', 'SPEI_RECO_OTHER_CONTEXT',
    'ISpEventSink', 'SSTTWildcard', 'SPPHRASE', 'DISPID_SGRSTsItem',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPAsItem', 'SRCS_Enabled',
    'SPWORDTYPE', 'SpeechTokenContext', 'DISPID_SLGetPronunciations',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SMSSetData',
    'SPSInterjection', 'SVSFParseSapi', 'DISPID_SRGCommit',
    'SPDATAKEYLOCATION', 'SPAO_RETAIN_AUDIO', 'ISpeechRecoResult2',
    'SVP_12', 'DISPID_SPPConfidence', 'DISPID_SBSWrite',
    'SPEI_MIN_SR', 'DISPID_SLRemovePronunciation', 'SDTDisplayText',
    'eLEXTYPE_VENDORLEXICON', 'SpCompressedLexicon', 'SpAudioFormat',
    'DISPID_SVEStreamEnd', 'SpeechCategoryVoices',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPBO_AHEAD',
    'SAFTADPCM_22kHzStereo', 'DISPID_SGRSTPropertyName',
    'SpeechRecoEvents', 'ISpRecoContext2', 'SPPHRASERULE',
    'DISPID_SRCERecognizerStateChange', 'SpeechCategoryRecoProfiles',
    'SPWT_LEXICAL', 'SpeechStreamSeekPositionType', 'ISpRecognizer',
    'DISPID_SPRulesCount', 'SRATopLevel', 'DISPID_SRCEAudioLevel',
    'SpeechVisemeFeature', 'DISPID_SAEventHandle',
    'SAFT44kHz16BitMono', 'DISPID_SVVolume',
    'SpeechEmulationCompareFlags', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechAudioFormat', 'SWPUnknownWordPronounceable',
    'SpeechDictationTopicSpelling', 'DISPID_SOTRemove', 'SPPS_Noun',
    'eLEXTYPE_PRIVATE6', 'SP_VISEME_9', 'SPPS_RESERVED2',
    'SAFT11kHz16BitMono', 'DISPID_SRGCmdSetRuleIdState',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPINTERFERENCE_TOOFAST',
    'SAFT48kHz16BitMono', 'ISpeechTextSelectionInformation',
    'SpeechTokenKeyAttributes', 'DISPID_SGRSTPropertyValue',
    'ISpeechRecoResult', 'DISPID_SPIAudioSizeBytes',
    'ISpeechPhraseRule', 'DISPID_SPEAudioTimeOffset',
    'SAFT12kHz8BitStereo', 'DISPID_SASNonBlockingIO',
    'ISpeechPhraseProperty', 'ISpRecoGrammar',
    'ISpeechPhraseProperties', 'SPAR_Unknown', 'SASRun',
    'DISPID_SPEEngineConfidence', 'DISPID_SVEBookmark',
    'eLEXTYPE_PRIVATE5', 'SVPAlert', 'SRAONone',
    'DISPID_SVSLastBookmark', 'ISpeechRecognizerStatus',
    'SREInterference', 'SAFT32kHz16BitMono', 'SPSHT_NotOverriden',
    'STCLocalServer', 'DISPID_SRAudioInputStream',
    'DISPID_SPRuleChildren', 'ISpResourceManager',
    'ISpeechBaseStream', 'DISPID_SPPsItem', 'SASStop', 'DISPIDSPTSI',
    'SREAdaptation', 'DISPID_SpeechLexiconWord', 'SPBOOKMARKOPTIONS',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SGRsAdd',
    'DISPID_SLPLangId', 'DISPID_SVSInputWordLength',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRCCmdMaxAlternates',
    'SSSPTRelativeToEnd', 'SPLOADOPTIONS', 'SITooSlow',
    'DISPID_SLPType', 'SpPhraseInfoBuilder',
    'DISPID_SOTCreateInstance', 'SPSLMA', 'DISPID_SGRSTNextState',
    'eLEXTYPE_PRIVATE10', 'ISpeechLexicon', 'SPRST_INACTIVE',
    'SAFTCCITT_ALaw_22kHzMono', 'ISpeechPhraseRules', 'SpVoice',
    'ISpeechRecoContext', 'DISPID_SRSetPropertyString',
    'SGDSActiveWithAutoPause', 'ISpeechLexiconPronunciations',
    'DISPID_SLGetWords', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPRST_ACTIVE', 'tagSTATSTG', 'DISPID_SpeechMemoryStream',
    'SAFTADPCM_44kHzMono', 'SAFT32kHz16BitStereo',
    'DISPID_SABufferNotifySize', 'DISPID_SpeechVoiceStatus',
    'SPCS_ENABLED', 'DISPID_SPEAudioSizeBytes', 'DISPID_SRCResume',
    'DISPID_SMSGetData', 'DISPID_SPPFirstElement',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SpeechPhraseBuilder', 'SPSEMANTICFORMAT',
    'DISPID_SRCEFalseRecognition', 'DISPID_SGRName', 'ISpeechAudio',
    'SVEBookmark', 'eWORDTYPE_ADDED', 'DISPID_SGRsCommitAndSave',
    'SVSFParseMask', 'SRAExport', 'SPPS_Noncontent',
    'ISpGrammarBuilder', 'SpObjectTokenCategory',
    'DISPID_SLPSymbolic', 'SDTAll', 'SSSPTRelativeToStart',
    'SAFTADPCM_22kHzMono', 'SPEI_FALSE_RECOGNITION', 'DISPID_SVSpeak',
    'ISpPhrase', 'DISPID_SLWLangId', 'DISPID_SVEVoiceChange',
    'ISpeechGrammarRuleStateTransitions', 'eLEXTYPE_PRIVATE20',
    'ISpMMSysAudio', 'DISPID_SLAddPronunciationByPhoneIds',
    'SVSFUnusedFlags', 'SBOPause', 'SVSFIsFilename',
    'ISpeechLexiconPronunciation', 'SREAllEvents',
    'SpeechBookmarkOptions', '_SPAUDIOSTATE', 'SAFT24kHz8BitStereo',
    'eLEXTYPE_PRIVATE9', 'ISpeechPhraseAlternate',
    'DISPID_SVEPhoneme', 'DISPID_SPERetainedSizeBytes',
    'SREStreamStart', 'SpInProcRecoContext',
    'DISPIDSPTSI_ActiveLength', 'ISpObjectWithToken',
    'DISPID_SRCEPropertyStringChange', 'IStream',
    'SAFT8kHz16BitStereo', 'SP_VISEME_1', 'ISpeechAudioStatus',
    'SPSTREAMFORMATTYPE', 'SPAUDIOSTATUS', 'SPSSuppressWord',
    'SGLexicalNoSpecialChars', 'SVP_11',
    'DISPID_SpeechRecognizerStatus', 'SAFTCCITT_uLaw_8kHzMono',
    'ISpeechFileStream', 'SpeechCategoryRecognizers',
    'eLEXTYPE_PRIVATE12', 'eLEXTYPE_PRIVATE11', 'DISPID_SLPPhoneIds',
    'SGRSTTWildcard', 'SDTRule', 'SPCT_SUB_DICTATION', 'SVF_Emphasis',
    'SVP_14', 'DISPID_SRGDictationLoad', 'DISPID_SPRNumberOfElements',
    'DISPID_SRCRetainedAudioFormat', 'SVP_6', 'SPXMLRESULTOPTIONS',
    'SPRECOCONTEXTSTATUS', 'SPWF_INPUT', 'DISPID_SRCEEndStream',
    'ISpRecoResult', 'Speech_StreamPos_RealTime', 'SSTTDictation',
    'ISpRecognizer2', 'SECHighConfidence', 'DISPID_SRRRecoContext',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPEs_NewEnum', 'SPBO_PAUSE', 'DISPID_SPIStartTime',
    'DISPID_SRRecognizer', 'SpeechGrammarTagUnlimitedDictation',
    'SP_VISEME_15', 'DISPID_SRCRetainedAudio', 'SRCS_Disabled',
    'DISPID_SPEAudioStreamOffset', 'SPSHT_Unknown',
    'ISpeechPhoneConverter', 'SpMMAudioOut', 'SPEVENT',
    'SpeechPropertyLowConfidenceThreshold', 'SAFTText',
    'SPEI_RESERVED2', 'SGSExclusive', 'SASPause', 'SPGRAMMARWORDTYPE',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechLexicon',
    'SAFTCCITT_ALaw_22kHzStereo', 'SGRSTTEpsilon',
    'ISpeechRecognizer', 'DISPID_SOTCId', 'DISPID_SDKDeleteValue',
    'SREBookmark', 'SSTTTextBuffer', 'DISPID_SVAudioOutput',
    'DISPID_SRRTLength', 'SPAUDIOBUFFERINFO', 'IEnumSpObjectTokens',
    'ISpPhraseAlt', '_RemotableHandle', 'SAFTDefault',
    'Speech_Max_Word_Length', 'SpNotifyTranslator',
    'DISPID_SpeechAudio', 'DISPID_SPIEngineId', 'SECFIgnoreCase',
    'DISPID_SPRules_NewEnum', 'SVEAllEvents', 'SAFTADPCM_11kHzMono',
    'SpeechRetainedAudioOptions', 'Speech_Default_Weight',
    'ISpObjectToken', 'DISPID_SRCRequestedUIType',
    '__MIDL_IWinTypes_0009', 'SPPROPERTYINFO',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SpeechPhraseAlternate',
    'SSSPTRelativeToCurrentPosition',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SDKEnumValues', 'DISPID_SRCState', 'SGRSTTRule',
    'SPPS_NotOverriden', 'SPPHRASEELEMENT', 'DISPID_SPAs_NewEnum',
    'DISPID_SRSAudioStatus', 'STSF_CommonAppData',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPISaveToMemory',
    'SPPHRASEPROPERTY', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechLexiconWords', 'SRSEIsSpeaking', 'SP_VISEME_3',
    'SVSFIsXML', 'SpeechPropertyHighConfidenceThreshold',
    'SpCustomStream', 'SpeechPartOfSpeech', 'SVEStartInputStream',
    'SVSFPurgeBeforeSpeak', 'SPEI_ADAPTATION', 'SpeechAllElements',
    'DISPID_SpeechRecoContext', 'SPPS_Interjection', 'SPVPRI_OVER',
    'SPCT_SUB_COMMAND', 'SpeechUserTraining', 'SPEI_PHONEME',
    'SPAO_NONE', 'DISPID_SpeechPhraseElement', 'DISPID_SVSVisemeId',
    'DISPID_SPRFirstElement', 'DISPID_SPELexicalForm',
    'DISPID_SGRsCommit', 'DISPID_SpeechGrammarRules', 'SVP_21',
    'DISPID_SPIProperties', 'SpeechAudioProperties',
    'DISPID_SpeechFileStream', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'ISpSerializeState', 'DISPID_SVAlertBoundary',
    'ISpeechGrammarRules', 'SpeechTokenKeyUI', 'DISPID_SGRsDynamic',
    'SVP_18', 'DISPID_SpeechXMLRecoResult', 'SREPrivate',
    'ISpeechMemoryStream', 'SPVPRIORITY', 'DISPID_SDKSetBinaryValue',
    'DISPID_SRGSetTextSelection', 'SAFTNoAssignedFormat',
    'SpeechTokenValueCLSID', 'DISPID_SVGetVoices',
    'SpeechRecoProfileProperties', 'DISPID_SABIBufferSize',
    'SVSFNLPSpeakPunc', 'DISPID_SOTId', 'SPPS_Unknown',
    'SAFT8kHz8BitStereo', 'SAFTCCITT_ALaw_44kHzStereo',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SpeechWaveFormatEx', 'SPWORD',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SGRSTText',
    'SPEI_RECO_STATE_CHANGE', 'SRERequestUI', 'SVP_20',
    'SWPKnownWordPronounceable', 'SPAS_STOP',
    'SpeechCategoryPhoneConverters', 'DISPID_SVGetAudioOutputs',
    'SDA_Consume_Leading_Spaces', 'SPAS_CLOSED',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPPEngineConfidence',
    'ISpPhoneticAlphabetConverter', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SpeechDataKey', 'ISpPhoneConverter',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPPARTOFSPEECH', 'ISpObjectTokenCategory',
    'DISPID_SPRuleFirstElement', 'DISPID_SDKGetStringValue',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPPsCount',
    'SAFT11kHz8BitStereo', 'ISequentialStream',
    'DISPID_SPEDisplayAttributes', 'SpStreamFormatConverter',
    'DISPID_SVPriority', 'DISPID_SPACommit', 'SVSFVoiceMask',
    'DISPID_SVSInputWordPosition', 'SVP_8',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRGRules',
    'DISPID_SDKEnumKeys', 'SPINTERFERENCE_NOISE', 'SPINTERFERENCE',
    'SDTAudio', 'eLEXTYPE_PRIVATE8', 'SDTPronunciation',
    'SAFT16kHz8BitMono', 'ISpRecoGrammar2', 'DISPID_SVRate',
    'DISPID_SpeechRecognizer', 'eLEXTYPE_RESERVED9',
    'DISPID_SOTsCount', 'SDTLexicalForm', 'DISPID_SPAsCount',
    'SVF_Stressed', 'DISPID_SGRClear', 'SVPOver',
    'DISPID_SVEEnginePrivate', 'SpeechPropertyAdaptationOn',
    'SpeechCategoryAppLexicons', 'DISPID_SPARecoResult',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRGCmdSetRuleState',
    'SP_VISEME_14', 'DISPID_SRRTStreamTime', 'SAFTGSM610_8kHzMono',
    'SWPUnknownWordUnpronounceable', 'SPRST_NUM_STATES',
    'SDKLLocalMachine', 'DISPID_SRIsShared',
    'SpeechVoiceCategoryTTSRate', 'SGRSTTTextBuffer',
    'DISPID_SOTs_NewEnum', 'SPSHT_OTHER', 'SVSFDefault',
    'SPRS_INACTIVE', 'SECFNoSpecialChars', 'DISPID_SABIEventBias',
    'DISPID_SpeechRecoContextEvents', 'SpMMAudioIn',
    'SRERecoOtherContext', 'DISPID_SRGDictationUnload', 'SPFILEMODE',
    'SAFTADPCM_8kHzStereo', 'IEnumString', 'SpShortcut',
    ...
    'SPSEMANTICERRORINFO', 'DISPID_SBSFormat',
    'DISPID_SPRuleConfidence', 'DISPID_SRGState',
    'SPADAPTATIONRELEVANCE', 'SP_VISEME_16', 'DISPID_SMSADeviceId',
    'SpeechDisplayAttributes', 'ISpeechPhraseAlternates',
    'SSFMOpenForRead', 'DISPID_SpeechPhraseProperty',
    'DISPID_SVESentenceBoundary', 'DISPID_SPCLangId', 'SVP_2',
    'SpPhoneConverter', '_ISpeechRecoContextEvents', 'DISPID_SLWType',
    'SPEI_TTS_PRIVATE', 'DISPID_SPRs_NewEnum', 'SPRST_ACTIVE_ALWAYS',
    'SAFT22kHz8BitMono', 'SECFDefault', 'STCAll',
    'DISPID_SVWaitUntilDone', 'SPXRO_SML', 'SPEI_WORD_BOUNDARY',
    'SGRSTTDictation', 'SAFT16kHz8BitStereo', 'SpeechAudioState',
    'SVP_5', 'DISPIDSPTSI_SelectionLength', 'SPFM_CREATE_ALWAYS',
    'SLOStatic', 'DISPID_SRCEHypothesis', 'SLODynamic',
    'DISPID_SAStatus', 'DISPID_SMSALineId', 'ISpVoice',
    'SPEI_PHRASE_START', 'SPEI_UNDEFINED',
    'DISPID_SRCreateRecoContext', 'DISPID_SRGId', 'DISPID_SASState',
    'STSF_FlagCreate', 'SP_VISEME_2', 'SPSFunction',
    'ISpeechGrammarRuleStateTransition',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPEI_PROPERTY_NUM_CHANGE',
    'SRTSMLTimeout', 'SRERecognition', 'DISPID_SRCRecognizer',
    'SPRECORESULTTIMES', 'DISPID_SpeechLexiconPronunciation',
    'SpeechInterference', 'SSFMCreate', 'ISpeechAudioFormat',
    'DISPID_SWFEChannels', 'DISPID_SABIMinNotification',
    'DISPID_SVSPhonemeId', 'DISPID_SGRSTsCount', 'DISPID_SPRuleName',
    'DISPID_SDKDeleteKey', 'eLEXTYPE_RESERVED10', 'DISPID_SLPsCount',
    'ISpeechVoiceStatus', 'eLEXTYPE_PRIVATE15', 'SAFTADPCM_8kHzMono',
    'SPAR_High', 'DISPID_SVIsUISupported', 'SAFT44kHz8BitMono',
    'DISPID_SRGReset', 'eLEXTYPE_PRIVATE14', 'DISPID_SPCIdToPhone',
    'DISPID_SRCEStartStream', 'SREPhraseStart', 'SAFT22kHz16BitMono',
    'SPRULE', 'SpSharedRecoContext', 'DISPID_SASFreeBufferSpace',
    'SP_VISEME_20', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPSERIALIZEDRESULT', 'SP_VISEME_4', 'SVF_None',
    'DISPID_SLGetGenerationChange', 'DISPID_SRCEInterference',
    'SpWaveFormatEx', 'SPEI_INTERFERENCE', 'SAFTCCITT_ALaw_8kHzMono',
    'SpeechTokenKeyFiles', 'SPGS_DISABLED', 'SREStreamEnd',
    'eLEXTYPE_PRIVATE18', 'ISpeechPhraseInfoBuilder',
    'SPCONTEXTSTATE', 'ISpeechPhraseReplacements',
    'DISPID_SLWs_NewEnum', 'SINone', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SVSLastResult', 'SPBO_TIME_UNITS', 'SPSUnknown',
    'DISPID_SVGetProfiles', 'DISPID_SGRSTransitions',
    'SRADefaultToActive', 'DISPID_SOTGetAttribute',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRGetRecognizers',
    'DISPID_SGRId', 'DISPID_SRRAlternates', 'DISPID_SVEWord',
    'SpObjectToken', 'DISPID_SGRsCount', 'SGDSInactive',
    'SPWORDPRONUNCIATIONLIST', 'SpeechAudioFormatGUIDWave',
    'SPCS_DISABLED', 'IInternetSecurityMgrSite', 'STSF_AppData',
    'tagSPTEXTSELECTIONINFO', 'SpeechEngineProperties',
    'DISPID_SOTSetId', 'DISPID_SPCPhoneToId', 'ISpXMLRecoResult',
    'DISPID_SPRsItem', 'DISPID_SRSCurrentStreamPosition',
    'SDTReplacement', 'ISpeechPhraseReplacement', 'SpeechRunState',
    'tagSPPROPERTYINFO', 'SVEVoiceChange', 'ISpStreamFormatConverter',
    'DISPID_SPPId', 'DISPID_SOTDisplayUI', 'SPSERIALIZEDPHRASE',
    'SLTApp', 'DISPID_SVSkip', 'SPBO_NONE', 'SPINTERFERENCE_NONE',
    'eLEXTYPE_PRIVATE1', 'SpeechVoicePriority',
    'DISPID_SDKGetBinaryValue', 'SITooQuiet', 'SAFT8kHz16BitMono',
    'SPPS_Verb', 'DISPID_SPPs_NewEnum', 'SPVPRI_NORMAL',
    'SAFT11kHz8BitMono', 'SP_VISEME_10', 'DISPID_SRCEPhraseStart',
    'eLEXTYPE_USER', 'SP_VISEME_21', 'DISPID_SRCEBookmark',
    'DISPID_SBSSeek', 'ISpeechRecoResultTimes', 'SpeechLoadOption',
    'SPPS_RESERVED1', 'DISPID_SpeechPhraseAlternates',
    'SPLEXICONTYPE', 'SVP_9', 'DISPID_SRRTimes', 'SVPNormal',
    'STCInprocHandler', 'DISPID_SRSNumberOfActiveRules',
    'SPPHRASEREPLACEMENT', 'ISpeechGrammarRuleState',
    'DISPID_SGRSTRule', 'SpeechVisemeType',
    'DISPID_SAFSetWaveFormatEx', 'SPEI_MAX_SR', 'SRAInterpreter',
    'SAFT24kHz16BitMono', 'SPPS_SuppressWord', 'ISpeechCustomStream',
    'SpeechAudioFormatGUIDText', 'SPSHT_EMAIL',
    'SAFT48kHz16BitStereo', 'SpSharedRecognizer', 'SVEPhoneme',
    'DISPID_SLGenerationId', 'DISPID_SADefaultFormat',
    'DISPID_SRGetFormat', 'DISPID_SVResume', 'SPAUDIOSTATE',
    'DISPID_SGRInitialState', 'ISpeechRecoGrammar',
    'SDA_No_Trailing_Space', 'DISPID_SWFEExtraData', 'SPSVerb',
    'SpeechPropertyNormalConfidenceThreshold', 'eLEXTYPE_PRIVATE7',
    'SVP_3', 'ISpeechMMSysAudio', 'DISPID_SDKSetStringValue',
    'SPSNotOverriden', 'DISPID_SOTCDefault', 'SVEViseme',
    'DISPID_SpeechRecoResult', 'SP_VISEME_17',
    'SpeechWordPronounceable', 'SP_VISEME_13',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPEI_START_SR_STREAM',
    'DISPID_SVEViseme', 'SAFT12kHz16BitMono',
    'DISPID_SpeechGrammarRuleState', 'SITooFast',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRRGetXMLResult',
    'eLEXTYPE_RESERVED7', 'eLEXTYPE_PRIVATE3',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRGetPropertyNumber',
    'SPEI_TTS_BOOKMARK', 'SINoSignal', 'SPEI_RESERVED6',
    'SPEVENTSOURCEINFO', 'SPPS_RESERVED3', 'UINT_PTR', 'SVSFIsNotXML',
    'SAFT12kHz16BitStereo', 'DISPID_SGRAttributes', 'DISPID_SRCVoice',
    'SPEI_SR_AUDIO_LEVEL', 'SPEI_HYPOTHESIS', 'DISPID_SGRsFindRule',
    'DISPID_SPANumberOfElementsInResult', 'SpeechLexiconType',
    'SpeechStreamFileMode', 'SPTEXTSELECTIONINFO', 'SDKLCurrentUser',
    'SREStateChange', 'SpeechAudioVolume', 'SpeechRuleAttributes',
    'SpeechVoiceSkipTypeSentence', 'SpeechDiscardType',
    'DISPID_SGRsItem', 'SPEI_MAX_TTS', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPPName', 'DISPID_SRAudioInput', 'SITooLoud',
    'ISpShortcut', 'SpeechGrammarTagDictation',
    'DISPID_SRIsUISupported', 'DISPID_SLPs_NewEnum', 'ISpRecognizer3',
    'SDKLCurrentConfig', 'SPINTERFERENCE_TOOQUIET', 'DISPID_SFSOpen',
    'SPVPRI_ALERT', 'DISPID_SWFEFormatTag', 'SVESentenceBoundary',
    'DISPID_SpeechCustomStream', 'ISpeechPhraseElements',
    'SDKLDefaultLocation', 'SPCATEGORYTYPE',
    'DISPID_SPRuleEngineConfidence', 'SPDKL_LocalMachine',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SpeechRegistryUserRoot',
    'DISPID_SPIGrammarId', 'SECNormalConfidence',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SLPsItem', 'SP_VISEME_11',
    'DISPID_SPPValue', 'SPINTERFERENCE_TOOLOUD', 'DISPIDSPRG',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpeechPhraseInfo',
    'SAFT48kHz8BitStereo', 'SVEWordBoundary',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPRDisplayAttributes',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SpeechPhraseInfo',
    'SPPS_Modifier', 'DISPID_SRGCmdLoadFromObject', 'LONG_PTR',
    'DISPID_SPPParent', 'SPEI_VOICE_CHANGE', 'SREHypothesis',
    'SAFT8kHz8BitMono', 'SVP_16', 'DISPID_SLWsItem', 'SWTAdded',
    'SpStream', 'SPPS_RESERVED4', 'DISPID_SRRAudioFormat',
    'SPEI_VISEME', 'DISPID_SRGCmdLoadFromResource', 'SPRECOSTATE',
    'SPAS_PAUSE', 'DISPID_SPIAudioSizeTime', 'DISPID_SPEDisplayText',
    'DISPID_SPEActualConfidence', 'DISPID_SPPChildren',
    'eLEXTYPE_PRIVATE4', 'DISPID_SLWPronunciations', 'SRTEmulated',
    'SECFEmulateResult', 'SVEAudioLevel', 'DISPID_SRCPause',
    'SAFTExtendedAudioFormat', 'DISPID_SOTsItem',
    'SREFalseRecognition', 'DISPID_SPAStartElementInResult',
    'eLEXTYPE_MORPHOLOGY', 'SpeechSpecialTransitionType',
    'DISPID_SWFEBlockAlign', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SPIEnginePrivateData',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SVSFParseAutodetect',
    'DISPID_SPIGetText', 'SRTReSent', 'SpeechRecoContextState',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpeechMicTraining', 'SREAudioLevel',
    'SREPropertyStringChange', 'SPSNoun', 'SAFTCCITT_uLaw_22kHzMono',
    'SRSEDone', 'ISpeechGrammarRule', '_ISpeechVoiceEvents',
    'ISpeechLexiconWord', 'eLEXTYPE_PRIVATE13',
    'SPEI_SR_RETAINEDAUDIO', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISpDataKey',
    'SPINTERFERENCE_NOSIGNAL', 'SpUnCompressedLexicon',
    'DISPID_SPEPronunciation', 'SP_VISEME_8', 'SpResourceManager',
    'ISpeechPhraseElement', 'DISPID_SREmulateRecognition',
    'ISpProperties', 'DISPID_SGRAddResource', 'WAVEFORMATEX',
    'DISPID_SpeechPhraseReplacement', 'SpeechAudioFormatType',
    'DISPID_SRRSaveToMemory', 'DISPID_SpeechLexiconWords',
    'DISPID_SPPNumberOfElements', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SPRsCount', 'eLEXTYPE_PRIVATE16', 'SPVISEMES',
    'SRESoundEnd', 'ISpLexicon', 'DISPID_SRCSetAdaptationData',
    'SVSFPersistXML', 'ISpNotifySource', 'SAFT24kHz16BitStereo',
    'SVSFParseSsml', 'SPEI_SOUND_END', 'SPAS_RUN',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SRRAudio',
    'DISPID_SpeechRecoResult2', 'DISPID_SVDisplayUI', 'SPLO_STATIC',
    'DISPID_SRDisplayUI', 'IInternetSecurityManager', 'SRADynamic',
    'SAFTCCITT_uLaw_11kHzMono', 'SAFTGSM610_22kHzMono',
    'ISpEventSource', 'SAFTCCITT_ALaw_11kHzMono', 'SGRSTTWord',
    'SAFT22kHz8BitStereo', 'SPSModifier', 'SGSDisabled',
    'SPEI_REQUEST_UI', 'SRAImport', 'SPEI_RECOGNITION',
    'DISPID_SPERequiredConfidence', 'SAFT22kHz16BitStereo',
    'DISPID_SPEAudioSizeTime', 'DISPID_SpeechPhoneConverter',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SVPause',
    'ISpStreamFormat', 'SpInprocRecognizer', 'SpeechGrammarState',
    'DISPID_SPERetainedStreamOffset', 'SpTextSelectionInformation',
    'DISPID_SPIElements', 'SVP_4', 'SPRS_ACTIVE',
    'ISpeechResourceLoader', 'DISPID_SVEAudioLevel',
    'DISPID_SOTCGetDataKey', 'SPDKL_CurrentConfig',
    'DISPID_SOTDataKey', 'SGDSActive', 'Speech_Max_Pron_Length',
    'DISPID_SRCEPropertyNumberChange', 'SP_VISEME_7', 'SPPS_Function',
    'SpeechRuleState', 'ISpeechWaveFormatEx',
    'DISPID_SRSetPropertyNumber', 'SREPropertyNumChange',
    'DISPID_SPIReplacements', 'DISPID_SPRuleId', 'SVP_15',
    'DISPID_SOTCSetId', 'DISPID_SWFEBitsPerSample', 'eLEXTYPE_APP',
    'eLEXTYPE_PRIVATE17', 'SPEI_SOUND_START', 'SRAORetainAudio',
    'DISPID_SPRulesItem', 'SPVOICESTATUS', 'SP_VISEME_12',
    'DISPID_SVEStreamStart', 'DISPID_SRGIsPronounceable',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'Speech_StreamPos_Asap',
    'DISPID_SpeechVoiceEvent', 'DISPID_SRCEventInterests',
    'SPFM_NUM_MODES', 'eLEXTYPE_RESERVED4', 'DISPID_SRProfile',
    'SSFMOpenReadWrite', 'ISpAudio', 'SRSInactive',
    'SPWT_PRONUNCIATION', 'SpeechGrammarWordType', 'DISPID_SGRSRule',
    'ISpRecoContext', 'DISPID_SGRAddState', 'SPEI_RESERVED5',
    'DISPID_SRCERequestUI', 'SINoise', 'DISPID_SGRSTWeight',
    'SECLowConfidence', 'SPEI_RESERVED3', 'SPWORDPRONUNCIATION',
    'DISPID_SpeechPhraseReplacements', 'SPSMF_UPS',
    'SpeechPropertyComplexResponseSpeed',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SGRSTType',
    'ISpNotifyTranslator', 'SPFM_OPEN_READWRITE',
    'SRSInactiveWithPurge', 'SPCT_COMMAND',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SAVolume', 'DISPID_SPIRule',
    'ISpeechDataKey', 'SPEI_SR_PRIVATE', 'SPPS_LMA',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRRTTickCount',
    'DISPID_SPIAudioStreamPosition', 'SP_VISEME_19',
    'ISpeechObjectTokenCategory', 'DISPID_SpeechBaseStream',
    'DISPID_SCSBaseStream', 'SAFT12kHz8BitMono',
    'DISPID_SPAPhraseInfo', 'STSF_LocalAppData', 'SPDKL_CurrentUser',
    'SAFT32kHz8BitStereo', 'DISPID_SRCCreateGrammar',
    'DISPID_SVEventInterests', 'SLTUser', 'DISPID_SpeechObjectToken',
    'ISpStream', 'DISPID_SpeechMMSysAudio', 'SPEI_START_INPUT_STREAM',
    'SPEI_SR_BOOKMARK', 'SRTExtendableParse', 'SpNullPhoneConverter',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SVStatus',
    'eLEXTYPE_PRIVATE19', 'DISPID_SVAudioOutputStream',
    'SPGS_EXCLUSIVE', 'DISPID_SRRSetTextFeedback',
    'SPINTERFERENCE_TOOSLOW', 'SpeechAddRemoveWord', 'DISPID_SBSRead',
    'DISPID_SRCEAdaptation', 'DISPID_SOTCategory', 'SPEI_MIN_TTS',
    'SGSEnabled', 'SPBINARYGRAMMAR', 'SPEI_END_INPUT_STREAM',
    'ISpeechAudioBufferInfo', 'SpMMAudioEnum', 'DISPID_SPRuleParent',
    'DISPID_SFSClose', 'SP_VISEME_18', 'DISPID_SDKSetLongValue',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPRuleNumberOfElements',
    'SpeechRecognizerState', 'SpeechVoiceEvents', 'SPRULESTATE',
    'SpeechPropertyResponseSpeed', 'DISPID_SOTIsUISupported',
    'SAFT48kHz8BitMono', 'DISPIDSPTSI_ActiveOffset', 'SGLexical',
    'DISPID_SPILanguageId', 'SVSFNLPMask', 'SPFM_CREATE',
    'SAFT44kHz16BitStereo', 'ISpeechObjectToken',
    'SpeechPropertyResourceUsage', 'SRTAutopause',
    'DISPID_SpeechAudioStatus', 'DISPID_SOTCEnumerateTokens',
    'SPGRAMMARSTATE', 'SAFT24kHz8BitMono', 'SPSMF_SAPI_PROPERTIES',
    'ISpNotifySink', 'DISPID_SVVoice', 'SpeechCategoryAudioOut',
    'DISPID_SRCERecognition', 'SGDisplay', 'SPLO_DYNAMIC',
    'SPWORDPRONOUNCEABLE', 'SAFTNonStandardFormat',
    'SAFTADPCM_11kHzStereo', 'SpeechEngineConfidence',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVSpeakStream', 'SPAR_Medium', 'SVP_17',
    'DISPID_SOTGetDescription', 'SAFTGSM610_44kHzMono', 'SFTSREngine',
    'SVEPrivate', 'DISPID_SRSSupportedLanguages', 'SWTDeleted',
    'DISPID_SRRPhraseInfo', 'SPCT_SLEEP', 'DISPID_SDKGetlongValue',
    'SPGS_ENABLED', 'SPWAVEFORMATTYPE', 'DISPID_SRState',
    'SDA_One_Trailing_Space', 'DISPID_SRCESoundEnd', 'SRSActive',
    'SPAUDIOOPTIONS', 'SpeechVoiceSpeakFlags', 'SECFIgnoreWidth',
    'STCRemoteServer', 'SPDKL_DefaultLocation', 'DISPID_SPEsCount',
    'DISPID_SRSClsidEngine', 'ISpRecoCategory', 'ISpeechObjectTokens',
    'SpFileStream', 'DISPID_SAFGetWaveFormatEx', 'SASClosed',
    'SPWF_SRENGINE', 'SPEI_END_SR_STREAM', 'SPSHORTCUTTYPE',
    'DISPID_SAFGuid', 'SVEEndInputStream', 'SAFTADPCM_44kHzStereo',
    'DISPID_SVSLastBookmarkId', 'DISPID_SPPBRestorePhraseFromMemory',
    'SRESoundStart', 'DISPID_SLWWord', 'SVP_7', 'SSFMCreateForWrite',
    'SVSFlagsAsync', 'SPXRO_Alternates_SML', 'SVP_0',
    'STCInprocServer', 'SVP_10', 'eLEXTYPE_LETTERTOSOUND',
    'SRTStandard', 'DISPID_SRSCurrentStreamNumber', 'SPAR_Low',
    'SAFT32kHz8BitMono', 'DISPID_SDKCreateKey',
    'DISPID_SpeechPhraseProperties', 'SFTInput', 'SRSActiveAlways',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SASCurrentSeekPosition',
    'SDTProperty', 'DISPID_SRGRecoContext', 'DISPID_SpeechVoice',
    'DISPID_SASetState', 'eLEXTYPE_PRIVATE2', 'SAFT16kHz16BitMono',
    'SAFTGSM610_11kHzMono', 'DISPID_SGRs_NewEnum',
